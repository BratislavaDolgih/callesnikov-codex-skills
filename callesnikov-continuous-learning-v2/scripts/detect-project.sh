...
#   2. CLAUDE_PROJECT_DIR env var (legacy fallback)
...
_clv2_detect_project() {
  ...
  # 1. Try Codex override, then the legacy Claude override
  local agent_project_dir="${CODEX_PROJECT_DIR:-${CLAUDE_PROJECT_DIR:-}}"
  ...
  # Normalize Windows backslashes so basename works with agent project overrides
